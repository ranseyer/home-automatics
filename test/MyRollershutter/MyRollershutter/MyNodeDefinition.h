...
#define RELAY_UPDOWN      11    // Digital I/O pin number for relay SPDT
#define RELAY_POWER       10    // Digital I/O pin number for relay SPST : Normally open, power off rollershutter motor, if A2==1 and A1==0 moveup, if A2==1 and A1==1 movedown, if A2==0 power off
#define MARK_UPDOWN      12    // Digital I/O pin number for relay SPDT
#define MARK_POWER       13    // Digital I/O pin number for relay SPST : Normally open, power off rollershutter motor, if A2==1 and A1==0 moveup, if A2==1 and A1==1 movedown, if A2==0 power off


//#define DEBUG_LED         6     // Digital I/O pin number for onboard debug led
#define BUTTON_STOP  5     // Digital I/O pin number for button Stop

#define BUTTON_UP         7    // Digital I/O pin number for button Up
#define BUTTON_DOWN       6    // Digital I/O pin number for button Down
#define MARK_UP           9    // Digital I/O pin number for button Up
#define MARK_DOWN         8    // Digital I/O pin number for button Down
